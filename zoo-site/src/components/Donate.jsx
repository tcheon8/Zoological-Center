  ...
  return (
    <div>
      <div id="donate">
        ...
        <br />
        <input type="text" placeholder="Enter Amount" size></input>
        <br />
        <input type="text" placeholder="Enter Email" size></input>
        <br />
        <br />
        <button class="button" onClick={() => {navigate("/thanks")}}>Donate</button>
      </div> 
    </div>
  );
}; 